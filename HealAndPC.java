...
public class HealAndPC {
	// This ArrayList will represent the Pokemon the trainer is currently
	// carrying.
	// For the ease of coding, we will assume that the trainer has, indeed,
	// caught them all.
	// We will also assume that the trainer has an infinite number of Pokemon in
	// the PC.
	// This makes coding easier by assuming Pokemon are a commodity.
	// This also foregoes the process of keeping track of Pokemon stored on the
	// PC.
	...
	public void depositPokemon(int dexNum) {
		// Finds the first Pokemon with the given Pokedex number in the team and
	...
	public void withdrawPokemon(int dexNum) {
		// Retrieves a Pokemon from the PC (that is, constructs a new Pokemon)
